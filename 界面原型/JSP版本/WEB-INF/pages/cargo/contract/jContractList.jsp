            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="update"><a href="#"
                                           onclick="formSubmit('contractAction_toupdate','_self');this.blur();">修改</a>
                        </li>
                        <li id="delete"><a href="#" onclick="formSubmit('contractAction_delete','_self');this.blur();">删除</a>
                        </li>
                        <li id="new"><a href="#"
                                        onclick="formSubmit('contractAction_submit','_self');this.blur();">上报</a></li>
                        <li id="new"><a href="#"
...
<input id="btnFind" type="button" name="查询" value="查询" onclick="formSubmit('contractAction_list','_self');this.blur();">
                ...
                <table id="ec_table" class="tableRegion" width="98%">
                    ...
                    <c:forEach items="${pb.datas}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                            ...
                            <td>
                                <a href="${ctx }/cargo/contractProductAction_tocreate?id=${o.contractId}">[货物]</a>
                            </td>
                        </tr>
                    </c:forEach>
