...
<head>
    ...
    <script>
        ...
        function toFinance() {
            if (isOnlyChecked()) {
                formSubmit('financeAction_invoice', '_self');
            } else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="delete"><a href="#"
                                           onclick="toFinance();this.blur();">财务</a>
                        </li>
                        <li id="view"><a href="#"
            ...
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <c:forEach items="${pb.datas}" var="o" varStatus="status">
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                        ...
                        <td>
                            <c:if test="${o.financeState==0}">草稿</c:if>
                            <c:if test="${o.financeState==1}"><b><font color="green">已上报</font></b></c:if>
                        </td>
                    </tr>
                </c:forEach>
