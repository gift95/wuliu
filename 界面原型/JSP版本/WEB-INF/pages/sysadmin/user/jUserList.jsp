            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="updateRole"><a href="#"
                                           onclick="toRole()">角色</a></li>
                        <li id="delete"><a href="#"
                                           onclick="formSubmit('userAction_delete','_self');this.blur();">删除</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <c:forEach items="${pb.datas}" var="o" varStatus="status">
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                        <td><input type="checkbox" name="id" value="${o.userId}"/></td>
                        <td>${status.index+1}</td>
                        <td><a href="userAction_toview?id=${o.userId}">${o.userName}</a></td>
